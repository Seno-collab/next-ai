...
export const messages = {
  vi: {
    ...
    login: {
      tagline: "QR Menu Identity",
      eyebrow: "Welcome back",
      title: "Đăng nhập hệ thống",
      subtitle: "Truy cập dashboard quản trị với trải nghiệm 3D qr.",
      cta: "Đăng nhập",
      ...
      visualCaption: "Kết nối an toàn, đồng bộ thời gian thực.",
    },
    logout: {
  ...
  en: {
    ...
    login: {
      ...
      subtitle: "Access the admin dashboard with a 3D QR experience.",
      cta: "Sign in",
      ...
      visualCaption: "Secure session with real-time sync.",
    },
    logout: {
      tagline: "Secure session",
      eyebrow: "Sign out",
